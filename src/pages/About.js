  ...
  return (
    <div className="about-page">
      <div className="about-content">
        ...
        <p>
          The Weather App was created by <strong>Kandala S V Ramalinggha Reddy</strong> to help users track live weather updates for any city in the world. 
        ...
        <div className="contact-section">
          ...
          <p>GitHub: <a href="https://github.com/KandalaSVRamalingghaReddy" target="_blank" rel="noreferrer">github.com/KandalaSVRamalingghaReddy</a></p>
        </div>
      </div>
    </div>
  );
